...
std::string DualNetworkBoard::GetBoardType() { return current_board_->GetBoardType(); }
...
NetworkInterface* DualNetworkBoard::GetNetwork() { return current_board_->GetNetwork(); }
...
std::string DualNetworkBoard::GetBoardJson() { return current_board_->GetBoardJson(); }
